...
BEGIN 
    INSERT INTO FILAS.TBSMS_CLASSE(
               ...
               VALUES(SQSMS_CLASSE_01.NEXTVAL,
                      'VOD_USAGE_NOW_ONLINE',
                      'Classe que integra VOD Usage NowOnline',
                      'MODCOB');
...
BEGIN
  ...
  SELECT ID_GRUPO_TAREFA
   ...
   WHERE NM_GRUPO_TAREFA = 'VOD_USAGE_RPT_GRP';
  --
  select ID_CLASSE
    INTO CLASSE1
    from FILAS.TBSMS_CLASSE
       ...
       DS_REGRA_ALERTA_MSG)
          VALUES
            (SQSMS_TAREFA_01.NEXTVAL,
             GRTA1,
             'VOD_USAGE_NOWONLINE_RPT_TR',
             'Tarefa integradora da plataforma VoD com o CRM',
             'br.com.netservicos.novosms.task.vod.ProcessarUsageVODNowTask',
             CLASSE1,
             1,
             1,
             'S',
