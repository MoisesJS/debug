...
BEGIN 
    INSERT INTO FILAS.TBSMS_CLASSE(
               ...
               VALUES(SQSMS_CLASSE_01.NEXTVAL,
                      'PROCESSA_LT_PROTOCOL',
                      'Classe que processa os lotes de protocolo',
                      'MODCOB');
...
BEGIN
  ...
  VALUES
    (sqsms_grupo_tarefa_01.NEXTVAL,
     'LOTE_PROTOCOLO',
     'Processos de Lote de Protocolo');
       ...
       DS_REGRA_ALERTA_MSG)
          VALUES
            (SQSMS_TAREFA_01.NEXTVAL,
             GRTA1,
             'PROCESSA_LT_PROTOCOL',
             'Tarefa para processamento dos lotes de protocolos',
             'br.com.netservicos.novosms.task.protocolo.ProcessarLoteProtocoloTask',
             CLASSE1,
             1,
             1,
             'S',
