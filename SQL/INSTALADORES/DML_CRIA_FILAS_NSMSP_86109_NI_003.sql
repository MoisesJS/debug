...
BEGIN 
    INSERT INTO FILAS.TBSMS_CLASSE(
               ...
               VALUES(SQSMS_CLASSE_01.NEXTVAL,
                      'PROCESSA_CHARGEBACK',
                      'Classe que processa os lotes de chargeback.',
                      'MODCOB');
       ...
       DS_REGRA_ALERTA_MSG)
          VALUES
            (SQSMS_TAREFA_01.NEXTVAL,
             GRTA1,
             'PROCESSA_CHARGEBACK',
             'Tarefa para processamento dos lotes de arquivos chargeback.',
             'br.com.netservicos.novosms.task.chargeback.ProcessarChargebackTask',
             CLASSE1,
             1,
             1,
             'S',
